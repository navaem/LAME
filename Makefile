...
OBJECTS += game_engine.o
OBJECTS += main.o
OBJECTS += screenAliens.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1523913772.62
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1523913772.62
